...
. Cloud Volumes ONTAP 9.12.1 P2および9.13.0 P2以降では、System ManagerおよびONTAP CLIを使用して、最大サイズ300TiBのFlexVolボリュームを作成できます。
...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-ha-google-cloud.html["Google Cloudで実行されるCloud Volumes ONTAP HAペアのストレージの仕組みを説明します"^]。
